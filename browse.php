...
<?php
    if (isset($_POST["submit"])) {              // zelfafhandelend formulier
        ...
        print("<a href='view.php?id=".$stockItemID."'>Artikel</a> toegevoegd aan <a href='cart.php'> winkelmandje!</a>");
            ...
            <!-- einde coderegel 1 van User story: bekijken producten   -->
                <div id="ProductFrame">
                    ...
                    <input type="number" name="stockItemID" value="<?php print($row["StockItemID"]); ?>" hidden>
                     <button type="submit" name="submit" class="buyBtn">Toevoegen aan winkelmand</button>
                    </form>
